...
<div class="col-md-6">
    ...
    <div class="form-group">
    <label>Nomor Whatsapp <i class="fa fa-whatsapp"></i></label>
    <input type="text" name="whatsapp" placeholder="contoh : 628123896724" value="<?php echo $site->whatsapp ?>" class="form-control">
    </div>
